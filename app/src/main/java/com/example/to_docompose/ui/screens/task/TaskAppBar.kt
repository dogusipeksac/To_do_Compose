...
fun NewTaskAppBar(navigateToListScreen: (Action)->Unit){
    TopAppBar(navigationIcon = {
        ...
        title = {
        Text(text = stringResource(R.string.add_task_string),
...
fun AddAction(onAddClicked:(Action)->Unit){
    IconButton(onClick = {
        ...
        Icon(imageVector =Icons.Filled.Check ,
            contentDescription = stringResource(R.string.add_task_string),
            tint = MaterialTheme.colors.topAppBarContentColor)
...
fun ExistingTaskAppBar(
    ...
    TopAppBar(navigationIcon = {
        ...
        actions = {
            ...
            ExistingTaskAppBarActions(selectedTask = selectedTask,
                navigateToListScreen = navigateToListScreen)
        }
    )
}
...
fun ExistingTaskAppBarPreview(){
   ...
   ToDoTask(id = 0,
       ...
       priority = Priority.MEDIUM),navigateToListScreen = {})
}
